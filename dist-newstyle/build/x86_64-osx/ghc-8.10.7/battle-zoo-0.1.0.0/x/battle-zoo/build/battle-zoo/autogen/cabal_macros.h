...
/* package battle-zoo-0.1.0.0 */
#ifndef VERSION_battle_zoo
#define VERSION_battle_zoo "0.1.0.0"
#endif /* VERSION_battle_zoo */
#ifndef MIN_VERSION_battle_zoo
#define MIN_VERSION_battle_zoo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_battle_zoo */
...
#define CURRENT_COMPONENT_ID "battle-zoo-0.1.0.0-inplace-battle-zoo"
